...
DEFAULT_CORPUS_ID = 'sers_alpha4b4a11_holdout_real_v1_corpus'
DEFAULT_IDENTITY_ID = 'sers_alpha4b4a11_holdout_real_v1_measurement_identity'
DEFAULT_COMPARISON_ID = 'sers_alpha4b4a11_holdout_real_v1_comparison'
DEFAULT_TREND_ID = 'sers_alpha4c211_seen_regression_v1'
DEFAULT_PRECISION_ID = 'sers_alpha4c211_seen_regression_precision_v1'
EXPECTED_PAPERS = ['Kiwook_SERS_2', 'Kiwook_SERS_6', 'Kiwook_SERS_10']
PHASE_LABEL = 'alpha4c.2.1.1 seen regression'
REPORT_NAME = 'seen_regression_report.json'
...
def main() -> int:
    ...
    regression_checks = seen_regression_checks(
        evidence_rows,
        annotation_rows,
        local_results,
    )
