...
SUITES = {
    "calibration": {
        ...
        "trend_id": "sers_alpha4c21211_calibration_v1",
        "precision_id": "sers_alpha4c21211_calibration_precision_v1",
    },
    "seen": {
        ...
        "trend_id": "sers_alpha4c21211_seen_regression_v1",
        "precision_id":
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "alpha4c.2.1.2.1.1 precision semantic reconciliation regression"
        )
    )
    parser.add_argument(
        "--suite",
...
def main() -> int:
    ...
    for suite in suites:
        ...
        report = {
            "phase": f"alpha4c.2.1.2.1.1 {suite}",
            "trend_semantics_id":
            ...
            "acceptance_note": (
                ...
                "Only the alpha4c.2.1.2.1.1 repairs and the explicitly "
