...
CRITICAL_COMPONENTS = (
    ...
    "campaigns/sers_alpha4_epoch/fresh_c/cli/build_sers_fresh_c_historical_exclusion_ledger_v1.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/verify_sers_fresh_c_historical_exclusion_ledger_v1.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/freeze_sers_fresh_c_activation_readiness_v1.py",
    ...
    "campaigns/sers_alpha4_epoch/alpha4/alpha4c5f2_reserve.py",
)
