...
from campaigns.sers_alpha4_epoch.fresh_c.cli.verify_sers_fresh_c_live_discovery_recovery_v2_1_protocol import verify
...
CRITICAL_COMPONENTS = (
    ...
    "campaigns/sers_alpha4_epoch/fresh_c/cli/verify_sers_fresh_c_live_discovery_recovery_v2_1_protocol.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/freeze_sers_fresh_c_live_discovery_recovery_v2_1_protocol.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/verify_sers_fresh_c_live_discovery_recovery_v2_1_protocol_freeze.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/run_sers_fresh_c_live_discovery_recovery_v2_1.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/verify_sers_fresh_c_live_discovery_recovery_v2_1_result.py",
...
def main() -> int:
    ...
    subprocess.run(
        [
            sys.executable,
            "-m",
            "campaigns.sers_alpha4_epoch.fresh_c.cli.verify_sers_fresh_c_live_discovery_recovery_v2_protocol_freeze",
        ],
        cwd=root,
        check=True,
    )
