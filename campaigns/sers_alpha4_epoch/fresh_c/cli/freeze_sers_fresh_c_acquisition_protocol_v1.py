...
CRITICAL_COMPONENTS = (
    ...
    "dac_her/sers_fresh_c_acquisition_protocol_v1.json",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/verify_sers_fresh_c_acquisition_protocol_v1.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/freeze_sers_fresh_c_acquisition_protocol_v1.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/verify_sers_fresh_c_acquisition_protocol_freeze_v1.py",
