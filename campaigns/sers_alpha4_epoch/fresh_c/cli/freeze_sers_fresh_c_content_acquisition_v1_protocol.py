...
CRITICAL_COMPONENTS = (
    "campaigns/sers_alpha4_epoch/fresh_c/fresh_c_content_acquisition_v1.py",
    "dac_her/sers_fresh_c_content_acquisition_v1_protocol.json",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/verify_sers_fresh_c_content_acquisition_v1_protocol.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/freeze_sers_fresh_c_content_acquisition_v1_protocol.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/verify_sers_fresh_c_content_acquisition_v1_protocol_freeze.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/run_sers_fresh_c_content_acquisition_v1.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/verify_sers_fresh_c_content_acquisition_v1_result.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/freeze_sers_fresh_c_content_acquisition_v1_result.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/verify_sers_fresh_c_content_acquisition_v1_result_freeze.py",
