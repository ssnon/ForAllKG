...
CRITICAL_COMPONENTS = (
    "campaigns/sers_alpha4_epoch/fresh_c/sers_fresh_c_final_closeout_v1.py",
    "dac_her/sers_fresh_c_final_closeout_protocol_v1.json",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/verify_sers_fresh_c_final_closeout_protocol_v1.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/build_sers_fresh_c_final_closeout_v1.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/verify_sers_fresh_c_final_closeout_v1.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/freeze_sers_fresh_c_final_closeout_v1.py",
    "campaigns/sers_alpha4_epoch/fresh_c/cli/verify_sers_fresh_c_final_closeout_freeze_v1.py",
