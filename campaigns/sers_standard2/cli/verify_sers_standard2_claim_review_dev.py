...
def main() -> int:
    ...
    from campaigns.sers_standard2.claim_review_dev_validation import sha256_json
    ...
    try:
        ...
        from campaigns.sers_standard2.claim_review_dev_validation import load_inputs
