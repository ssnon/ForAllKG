...
class ValidationSpecificationCompiler:
    ...
    def compile(
        ...
        return ValidationSpecification(
            ...
            validation_strategy=_strategy(scope),
            ...
            required_scientific_checks=required,
            not_applicable_scientific_checks=not_applicable,
            required_physics_checks=required,  # legacy compatibility
            not_applicable_physics_checks=not_applicable,  # legacy compatibility
