...
class VocabularyEntryProtocol(Protocol):
    entry_id: str
    label: str
    metadata: Mapping[str, Any]


class ParameterizedVocabularyMatchProtocol(
    Protocol
):
    entry: VocabularyEntryProtocol | None
    parameters: Mapping[str, str]
    matched_pattern: str | None


class VocabularyRegistryProtocol(Protocol):
    ...
    ) -> ParameterizedVocabularyMatchProtocol:
        ...
...
def _append_parameter_conditions(
    ...
    *,
    parameter_condition_names: AbstractSet[str],
) -> list[Condition]:
...
def normalize_graph_vocabularies(
    ...
    *,
    experiment_registry: VocabularyRegistryProtocol,
    metric_registry: VocabularyRegistryProtocol,
    metric_refiner: MetricRefiner,
    parameter_condition_names: AbstractSet[str],
    ...
    for node in graph.measurements:
        refined_metric_id = metric_refiner(
