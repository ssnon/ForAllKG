...
class CandidateDecisionCard(StrictModel):
    schema_version: Literal[
        "candidate-decision-card-v02",
        "candidate-decision-card-v03",
    ] = "candidate-decision-card-v02"
    decision_id: str
    hypothesis_id: str
    ...
    # Generic alpha3 scope mirrors.
    system_class: str = "unknown"
    scientific_domain: str = "unknown"
    process: str = "unknown"

    # Legacy HER-era field preserved for old viewers/artifacts.
...
class CandidateDecisionPortfolio(StrictModel):
    schema_version: Literal[
        ...
        "candidate-decision-portfolio-v03",
    ] = "candidate-decision-portfolio-v02"
