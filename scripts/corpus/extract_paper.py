...
import scripts.corpus.strict_extraction_runtime as extraction_module
...
from scripts.corpus.strict_extraction_runtime import chunk_output_path, extract_one_chunk, load_existing_result
...
def main() -> None:
    ...
    telemetry_resolution_count = append_extraction_artifact_resolutions(
        None,
        run_id=run_id,
        paper_id=paper.paper_id,
    ...
    summary = {
        ...
        "paper_status": paper_status,
        "graph_materialization_status": materialization_status,
        "telemetry_artifact_resolution_count": (
            telemetry_resolution_count
        ),
