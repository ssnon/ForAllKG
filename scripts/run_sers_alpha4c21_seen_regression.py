...
DEFAULT_TREND_ID = 'sers_alpha4c21_seen_regression_v1'
DEFAULT_PRECISION_ID = 'sers_alpha4c21_seen_regression_precision_v1'
EXPECTED_PAPERS = ['Kiwook_SERS_2', 'Kiwook_SERS_6', 'Kiwook_SERS_10']
PHASE_LABEL = 'alpha4c.2.1 seen regression'
