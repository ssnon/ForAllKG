...
SUITES = {
    "calibration": {
        ...
        "trend_id": "sers_alpha4c2121_calibration_v1",
        "precision_id": "sers_alpha4c2121_calibration_precision_v1",
    },
    "seen": {
        ...
        "trend_id": "sers_alpha4c2121_seen_regression_v1",
        "precision_id":
            "sers_alpha4c2121_seen_regression_precision_v1",
    },
}
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "alpha4c.2.1.2.1 canonical-claim re-grounding regression"
        )
    )
    parser.add_argument(
        "--suite",
    ...
    for suite in suites:
        ...
        report = {
            ...
            "acceptance_note": (
                ...
                "Only the alpha4c.2.1.2.1 repairs and the explicitly "
