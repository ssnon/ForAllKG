...
CRITICAL_COMPONENTS = (
    "dac_her/fresh_c_c1b1_reviewer_contract_v1.py",
    "dac_her/sers_fresh_c_c1b1_reviewer_protocol_v1.json",
    "scripts/verify_sers_fresh_c_c1b1_reviewer_protocol_v1.py",
    "scripts/freeze_sers_fresh_c_c1b1_reviewer_protocol_v1.py",
    "scripts/verify_sers_fresh_c_c1b1_reviewer_protocol_freeze_v1.py",
