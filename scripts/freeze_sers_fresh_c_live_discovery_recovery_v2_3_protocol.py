...
CRITICAL_COMPONENTS = (
    ...
    "scripts/verify_sers_fresh_c_live_discovery_recovery_v2_3_protocol.py",
    "scripts/freeze_sers_fresh_c_live_discovery_recovery_v2_3_protocol.py",
    "scripts/verify_sers_fresh_c_live_discovery_recovery_v2_3_protocol_freeze.py",
    "scripts/run_sers_fresh_c_live_discovery_recovery_v2_3.py",
    "scripts/verify_sers_fresh_c_live_discovery_recovery_v2_3_result.py",
