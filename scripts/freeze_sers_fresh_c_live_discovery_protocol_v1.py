...
from scripts.verify_sers_fresh_c_live_discovery_protocol_v1 import verify


CRITICAL_COMPONENTS = (
    "dac_her/fresh_c_live_discovery.py",
    "dac_her/sers_fresh_c_live_discovery_protocol_v1.json",
    "scripts/verify_sers_fresh_c_live_discovery_protocol_v1.py",
    "scripts/freeze_sers_fresh_c_live_discovery_protocol_v1.py",
    "scripts/verify_sers_fresh_c_live_discovery_protocol_freeze_v1.py",
    "scripts/run_sers_fresh_c_live_discovery_v1.py",
    "scripts/verify_sers_fresh_c_live_discovery_result_v1.py",
