...
CRITICAL_COMPONENTS = (
    "dac_her/fresh_c_c1a_materialization_v1.py",
    "dac_her/sers_fresh_c_c1a_materialization_v1_protocol.json",
    "scripts/verify_sers_fresh_c_c1a_materialization_v1_protocol.py",
    "scripts/freeze_sers_fresh_c_c1a_materialization_v1_protocol.py",
    "scripts/verify_sers_fresh_c_c1a_materialization_v1_protocol_freeze.py",
    "scripts/run_sers_fresh_c_c1a_materialization_v1.py",
    "scripts/verify_sers_fresh_c_c1a_materialization_v1_result.py",
    "scripts/freeze_sers_fresh_c_c1a_materialization_v1_result.py",
    "scripts/verify_sers_fresh_c_c1a_materialization_v1_result_freeze.py",
