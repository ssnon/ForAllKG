...
from dac_her.hypothesis_trend_directional_llm import (
    InstructorOpenAICompatibleDirectionAwareTrendBackend,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run alpha4c.5d.1 direction-aware Trend Hypothesis Maker. "
            "This is an additive precision runtime over frozen 5a-5d."
        )
    )
...
def main() -> None:
    ...
    _write_json(
        Path(str(prefix) + ".directional_exposure.json"),
        exposure,
    )
    ...
    if args.save_prompt or args.dry_run_prompt:
        ...
        print("Directional exposure ID:", exposure.exposure_id)
        print(
            "Directional exposure SHA256:",
            exposure.exposure_sha256,
        )
        print(
            "Source 5d exposure:",
    ...
    if outcome.accepted_portfolio is not None:
        ...
        print(
            "No direction-aware Trend hypothesis portfolio was "
