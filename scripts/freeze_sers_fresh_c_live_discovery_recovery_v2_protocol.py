...
from scripts.verify_sers_fresh_c_live_discovery_recovery_v2_protocol import (
    verify,
)
...
CRITICAL_COMPONENTS = (
    ...
    "scripts/verify_sers_fresh_c_live_discovery_recovery_v2_protocol.py",
    "scripts/freeze_sers_fresh_c_live_discovery_recovery_v2_protocol.py",
    "scripts/verify_sers_fresh_c_live_discovery_recovery_v2_protocol_freeze.py",
    "scripts/run_sers_fresh_c_live_discovery_recovery_v2.py",
    "scripts/verify_sers_fresh_c_live_discovery_recovery_v2_result.py",
