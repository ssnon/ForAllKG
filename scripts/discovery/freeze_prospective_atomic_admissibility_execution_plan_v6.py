...
def main() -> int:
    ...
    if output.exists():
        raise ValueError("v6 execution plan is write-once")

    campaign = ProspectiveAtomicAdmissibilityFreezeV6.model_validate_json(
    ...
    plan = build_prospective_atomic_admissibility_execution_plan_v6(
    ...
    print("P34-P38 v6 execution plan frozen")
