...
def main() -> int:
    ...
    if output.exists():
        raise ValueError("v6 campaign freeze is write-once")

    spec = ProspectiveAtomicAdmissibilitySpecV6.model_validate_json(
        spec_path.read_text(encoding="utf-8")
    )
    infra = ProspectiveAtomicAdmissibilityFreezeV5.model_validate_json(
    ...
    frozen = build_prospective_atomic_admissibility_freeze_v6(
        spec=spec,
    ...
    print("P34-P38 v6 campaign frozen")
