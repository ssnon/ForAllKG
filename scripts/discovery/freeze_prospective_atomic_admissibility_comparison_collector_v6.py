...
def main() -> int:
    ...
    if output.exists():
        raise ValueError("v6 collector freeze is write-once")
    if comparison.exists():
        raise ValueError("v6 comparison output already exists")

    plan = ProspectiveAtomicAdmissibilityExecutionPlanV6.model_validate_json(
    ...
    print("P34-P38 v6 comparison collector frozen")
