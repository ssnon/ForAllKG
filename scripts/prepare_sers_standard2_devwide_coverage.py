...
def main() -> int:
    ...
    if output_root.exists():
        print("standard2 DEV-wide coverage spec preflight: FAIL")
    ...
    print("SERS STANDARD_2_PROVIDER DEV-wide Coverage Specification")
    ...
    spec_path = output_root / "coverage_spec.json"
    ...
    print("standard2 DEV-wide coverage specification: FROZEN")
