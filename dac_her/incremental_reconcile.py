...
from pipeline_core.reconcile_freshness import (
    contract_diff as _shared_contract_diff,
    run_compatibility_reason as _shared_run_compatibility_reason,
    run_contract as _shared_run_contract,
    semantic_paper_payload_from_run as _shared_semantic_paper_payload_from_run,
...
class IncrementalCorpusReconciler:
    ...
    @staticmethod
    def _semantic_paper_payload_from_run(
        value: Any,
    ) -> dict[str, Any] | None:
        return (
            _shared_semantic_paper_payload_from_run(
                value
            )
        )
    ...
    def _semantic_policy_payload(
        ...
        return (
            _shared_semantic_policy_payload(
                value
            )
        )
    ...
    def _run_compatibility_reason(
        ...
        return (
            _shared_run_compatibility_reason(
                run_meta,
                current,
                freshness=(
