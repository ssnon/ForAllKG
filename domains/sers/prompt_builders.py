"""SERS-owned extraction user-prompt builders.

H1b-S transfers ownership of the effective extraction user-prompt envelope
away from DAC-HER without changing generated prompt text. Scientific SERS
semantics remain owned by domains.sers.prompts system/patch/micro prompts.

The initial implementations intentionally preserve the pre-H1b callable
behavior exactly. Future SERS-specific changes must be reviewed as explicit
