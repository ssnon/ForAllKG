...
| Feasibility adapter | Yes | [dac_her/domains/dac_her_feasibility.py](../../dac_her/domains/dac_her_feasibility.py) | None registered | HER owns older validated feasibility stack |
